      ...
      <form @submit.prevent="handleSubmit" class="join-form">
        <div class="form-group">
          ...
          <input
            ...
            required
          />
          <span class="hint">Ask the GM for the campaign invite code</span>
        </div>
...
async function handleSubmit() {
  ...
  const campaign = await campaignStore.joinCampaign(inviteCode.value.trim().toUpperCase())
  ...
  if (campaign) {
    ...
    error.value = campaignStore.error.value || 'Invalid invite code or campaign is full'
  }
}
</script>
